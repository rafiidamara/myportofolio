...
<html lang="en">
  ...
  <body>
    ...
    <div id="home"></div>
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top p-3" style="background-color: #BDC3C7;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 200"><path fill="#BDC3C7" fill-opacity="1" d="M0,192L80,170.7C160,149,320,107,480,112C640,117,800,171,960,186.7C1120,203,1280,181,1360,170.7L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    ...
    <div class="jumbotron-sm jumbotron-fluid mb-5" style="height: 600px; background-color: #fff; background-size: cover; background-position-y: -150px;">
      <div class="container-sm text-dark text-center">
       ...
       <?php
        echo "<a class='btn btn-warning me-1' name='edita' href='formprofil.php?id=".$profil['id']."'>Edit Profil</a> ";
       ?>
    ...
    <div class="card" style="background-color: #ECF0F1;">
      <div class="container-sm" style="margin-top: 200px; margin-bottom: 450px;">
        ...
        <div class="col-sm justify-content text-center fs-5">
          ...
          <?php
          echo "<a class='btn btn-warning me-1' name='edita' href='formabout.php?id=".$about['id']."'>Edit About</a> ";
    ...
    <section class="pb-5">
      <h1 class="text-center fw-bold mb-5 display-5 text-dark" style="padding-top: 100px">Gallery</h1>
      <div class="container-sm ">
            ...
            <div class="col-md-4 mb-5">
              <div class="card shadow-sm" style="width: 98%;">
                ...
                <div class="card-footer bg-light">
                  <?php
                  echo "<a class='btn btn-warning me-1' style='width:48%;' onclick='add()'' name='simpan' href='formgallery.php?id=".$isi['id']."'>Edit</a> ";
                  echo "<a class='btn btn-danger ms-1' style='width:48%;' href='galleryhapus.php?id=".$isi['id']."'>Hapus</a>";
                  ?>
                </div>
              </div>
            </div>
...
<!-- Modal Input Gallery -->
          ...
          <div class="card shadow mb-3 mt-3">
            <div class="card-body">
              ...
              <p class="card-text">"<?php echo $con['komentar'] ?>"</p>
                <?php
                echo "<a class='btn btn-danger ms-1' style='width:15%;' href='hapuscontact.php?id=".$con['id']."'>Hapus</a>";
                ?>
            </div>
          </div>
        </div>
   ...
   <!-- Footer -->
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#BDC3C7" fill-opacity="1" d="M0,192L80,170.7C160,149,320,107,480,112C640,117,800,171,960,186.7C1120,203,1280,181,1360,170.7L1440,160L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
   <footer class="footer position-relative text-center pb-3" style="background-color: #BDC3C7;">
     <div class="text-center fw-bolder text-dark">
