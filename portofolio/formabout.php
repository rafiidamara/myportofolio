...
<html lang="en">
  <head>
    ...
    <title>Portofolio | Edit-About</title>
  </head>
...
<!-- Form Edit -->
  ...
  <div class="container">
            ...
            <h3 class="fw-bold text-dark rounded text-center p-2" style="background-color: #BDC3C7;">Edit About</h3>
            ...
            <form action="editabout.php" method="POST">
                <div class="card-body">
                      ...
                      <button class="btn mt-3 mb-3 btn btn-success text-center" style="width: 15%;" name="edita" value="edit">Simpan Perubahan</button>
